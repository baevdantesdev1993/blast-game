...
import {IBaseComponent, IBlock, IPosition} from '../interfaces';
...
export default class BlockScene implements IBaseComponent {
	...
	public async render() {
		...
		this.sprite.x = this.startX + (this.props.position.x * BLOCK_SIZE);
		this.sprite.y = this.startY + (this.props.position.y * BLOCK_SIZE);
